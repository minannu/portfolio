...
import aboutMeData from "../database/about-me.json";
import educationData from "../database/education.json";
import recentUpdatesData from "../database/recent-updates.json";
import InfoSection from "../components/InfoSection";

const { aboutMe } = aboutMeData;
const { education } = educationData;
const { recentUpdates } = recentUpdatesData;
